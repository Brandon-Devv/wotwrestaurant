...
export default function MenuPage() {
  ...
  return (
    <main className="p-6 min-h-screen bg-fixed bg-cover bg-center" style={{ backgroundImage: "url('/images/fondovectores.png')" }}>
      <div className="max-w-7xl mx-auto bg-white bg-opacity-95 shadow-2xl rounded-2xl p-8">
        <h1 className="text-4xl font-bold mb-8 text-center text-green-800 drop-shadow">🍽️ Menú del Restaurante</h1>
